...
ggdag(dag_simple, text = FALSE, use_labels = "label") +
  theme_dag() +
...
ggdag(dag_confounding, text = FALSE, use_labels = "label") +
  theme_dag() +
  theme(legend.position = "none")
```
...
ggdag(dag_mediator, text = FALSE, use_labels = "label") +
  theme_dag() +
  theme(legend.position = "none")
```
...
ggdag(dag_collider, text = FALSE, use_labels = "label") +
  theme_dag() +
  theme(legend.position = "none")
```
...
ggdag(dag_complex, text = FALSE, use_labels = "label") +
  theme_dag() +
  theme(legend.position = "none")
```
...
ggdag(dag_hospital, text = FALSE, use_labels = "label") +
  theme_dag() +
  theme(legend.position = "none")
```
...
ggdag(dag_do, text = TRUE) +
  theme_dag() +
  theme(legend.position = "none") +
  annotate("text", x = 0.5, y = 0.6, label = "✗", size = 8, color = "red") +
