...
subtitle: "Lecture Notes — Unit 1: Experimental Design"
code-fold: true
---
...
![Type 1 and Type 2 Errors](media/HypothesisTesting.png)
...
I know this is a lot of math, so to help you visualize what's going on, I created a Shiny app last year that lets you play around with different values and see how the "optimal" $n_0$ and $n_1$ changes. Play around with the parameters and see what happens.

::: callout-tip
**Interactive App:** An interactive Shiny app for exploring optimal design tradeoffs was developed for the Spring 2025 version of this course. Ask in class or on Slack if you'd like access.
:::
...
Another trick is to measure outcomes repeatedly and average them. For example, do two lab tests for the same biomarker and average them. Or measure mental health weekly for 4 weeks. Each additional measurement can reduce the measurement error component.
...
::: callout-note
This will be a major topic in Unit 2.
:::
...
That's it for now. Next up, we'll look at more advanced randomization strategies (e.g., stratified, matched-pair, and adaptive designs) that can further improve your power.
