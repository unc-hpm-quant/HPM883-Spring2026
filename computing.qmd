...
|--------------|---------|------|
| **HPM-883-course** | Baseline materials (instructor-only) | [github.com/HPM-883-course](https://github.com/HPM-883-course) |
| **HPM-883-2026** | Student-facing content for Spring 2026 | [github.com/HPM-883-2026](https://github.com/HPM-883-2026) |
| **GitHub Classroom** | Assignment distribution & submission | [Classroom](https://classroom.github.com/classrooms/253497296-hpm-883-s26) |

### Tier 2: Local Development (Alternative)

For the capstone project or if you prefer working offline, you can work locally using **Positron** (recommended) or RStudio.
