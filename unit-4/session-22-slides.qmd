...
format:
  revealjs:
    ...
    footer: "HPM 883 | Session 22: Policy Trees & Optimal Targeting"
    toc: true
    toc-depth: 1
    preview-links: auto
    incremental: false
...
- **PS 3 due today** at 11:15am (HTE & Causal Forests)
...
"We'll go deeper with policy trees in the next unit." — that's today.
:::
...
**Unit 5 (next week):** Adaptive Experiments
:::
...
::: fragment
![](../images/cate-distribution.png){fig-alt="Histogram of estimated CATEs ranging from -0.3 to +0.9 with most patients near zero" width="70%"}
:::
...
::: fragment
But $V(\pi)$ has a scale that depends on the outcome. And optimizing it directly has tricky sample properties — good lecture-hall math, bad finite-sample behavior.
:::
...
[**colab.research.google.com/github/unc-hpm-quant/HPM883-Spring2026/blob/main/unit-4/session-22-policy-trees-demo.ipynb**](https://colab.research.google.com/github/unc-hpm-quant/HPM883-Spring2026/blob/main/unit-4/session-22-policy-trees-demo.ipynb)
...
# Part 6: Wrap & PS 4 {.center}

## The Recap in One Slide
...
::: {.fragment .callout-tip appearance="simple"}
**Heads up:** PS 4 is the shorter of the remaining two. The Wednesday lecture previews off-policy evaluation in detail — don't start Task 3 before then unless you're comfortable with AIPW.
:::
...
**If you're still stuck on PS 3 repo access:** email me directly with your GitHub username so I can add you manually.
