...
-   D'Amour et al. (2021) — "Overlap in Observational Studies with High-Dimensional Covariates"
...
-   [Lab 3: DML Implementation](../labs/lab-3-dml.qmd)
...
5.  **Diagnostics and Best Practices**
    ...
    -   The overlap curse of dimensionality (D'Amour et al. 2021)
    -   Trimming, truncation, and overlap weighting tradeoffs
...
-   **Session 2.5 (Feb 25):** Doubly-Robust Estimation — AIPW & TMLE
