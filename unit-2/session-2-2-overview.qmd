...
-   **Chapter 4:** Neyman Orthogonality — [Online PDF](https://causalml-book.org/chapters/CausalML_chap_4.pdf)
    -   Focus: Orthogonal scores, influence functions, semiparametric efficiency
-   **Chapter 5:** Causal Inference via Conditional Ignorability — [Online PDF](https://causalml-book.org/chapters/CausalML_chap_5.pdf)
    -   Focus: Selection on observables, propensity scores, doubly-robust estimators
-   **Chapter 9:** Double/Debiased Machine Learning — [Online PDF](https://causalml-book.org/chapters/CausalML_chap_9.pdf)
    -   Focus: DML algorithm, connection to Neyman orthogonal scores, cross-fitting
...
-   Chernozhukov et al. (2025) **Chapter 13:** Extensions of DML — [Online PDF](https://causalml-book.org/chapters/CausalML_chap_13.pdf) — *IV models (IIVM), proxy controls, robust inference under weak identification*
