...
**Monday Feb 23 (Remote):** Lab 2 Part 1 — Regularization in Practice. Hands-on with LASSO, Ridge, Elastic Net, and the instability demo in R.

**Wednesday Feb 25 (In-Person):** Trees & Ensemble Methods (Session 2.1b) + Lab 2 Part 2. Decision trees, random forests, gradient boosting, and model comparison.

**Monday Mar 2 (In-Person):** Jigsaw 2 — ML for Causal Inference. Then: From Influence Functions to DML.
:::
...
- **PS1 due Wednesday Feb 25** at 11:15am via GitHub Classroom
- Questions about PS1? Office hours or by appointment
- Start reading Chernozhukov et al. (2025) Chapter 5 for the DML sessions in Week 8
