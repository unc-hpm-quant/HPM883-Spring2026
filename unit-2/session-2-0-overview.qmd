...
subtitle: "Session 2.0: ML Foundations for Causal Inference"
...
**Format:** Async/Self-Study (Instructor traveling)

::: callout-important
## Self-Study Session
This is an asynchronous session. Complete the videos and readings before the guest lecture on Feb 4.
:::
...
-   [Self-Study Materials](session-2-0-workbook.qmd)
...
-   **Session 2.1 (Feb 4):** Guest Lecture — Tara Templin (Stanford)
-   **Session 2.2 (Feb 9):** Influence Functions & Neyman Orthogonality
-   Complete Chernozhukov et al. Chapter 5 (Conditional Ignorability) reading
