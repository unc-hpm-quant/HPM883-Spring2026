...
::: callout-note
## Combined with Session 2.2
This material is covered alongside Session 2.2 in a single combined session on Feb 18. See the [Session 2.2-2.3 overview](session-2-2-overview.qmd) for the combined session plan.
:::
...
**Format:** [Remote](https://zoom.us/j/93346316978) (combined with Session 2.2)
