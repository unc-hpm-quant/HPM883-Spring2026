...
|---------|------|-------|-----------|
| 2.0 | Feb 4 | Guest Lecture — Yunwei Chen (Stanford) | [overview](session-2-0-overview.qmd) |
| 2.1 | Feb 16 | ML Foundations for Causal Inference | [overview](session-2-1-overview.qmd), [slides](session-2-1-slides.qmd) |
| 2.2-2.3 | Feb 18 | From Influence Functions to DML: Orthogonality & Cross-Fitting | [overview](session-2-2-overview.qmd), [slides](session-2-2-slides.qmd) |
| 2.4 | Feb 23 | DML Implementation with DoubleML | [overview](session-2-4-overview.qmd), [workbook](session-2-4-workbook.qmd) |
| 2.5 | Feb 25 | Doubly-Robust Estimation: AIPW & TMLE | [overview](session-2-5-overview.qmd), [slides](session-2-5-slides.qmd) |
| 2.6 | Mar 2 | DR Estimation Lab | [overview](session-2-6-overview.qmd), [workbook](session-2-6-workbook.qmd) |

::: callout-note
## Note: February 9 is Well-Being Day (No Class)
The Feb 11 PS1 Prep Workshop is the only session during Week 5. Session 2.1 (ML Foundations) begins Feb 16.
:::
...
- **Chernozhukov et al. (2018)** — "Double/Debiased Machine Learning" *Econometrics Journal* — [DOI](https://doi.org/10.1111/ectj.12097)
...
- **D'Amour et al. (2021)** — "Overlap in Observational Studies with High-Dimensional Covariates" *Journal of Econometrics*
  - Why overlap assumptions break down in high dimensions — essential context for DML limitations
...
- Ahrens et al. (2025) — "An Introduction to Double/Debiased Machine Learning" — [arXiv:2504.08324](https://arxiv.org/abs/2504.08324)
...
- **Problem Set 2:** Double ML Implementation — Due March 13
